        ...
        <div class="worker-header">
            <div class="profile-container">
                ...
                <div class="profile-info">
                    <div class="profile-name"><?php echo htmlspecialchars($_SESSION['agente_nombre'] ?? 'Trabajador'); ?></div>
                    <div class="profile-email"><?php echo htmlspecialchars($_SESSION['agente_email'] ?? 'trabajador@ejemplo.com'); ?></div>
                </div>
            </div>
        </div>

        <nav class="worker-menu">
            <!-- Dashboard -->
            <a href="router.php?page=trabajador_dashboard" class="menu-item active">
                <i class="fas fa-tachometer-alt"></i>
                <span>Dashboard</span>
            </a>

            <!-- Mis denuncias -->
            <a href="router.php?page=listar_denuncias" class="menu-item">
                <i class="fas fa-exclamation-triangle"></i>
                <span>Denuncias</span>
            </a>

            <!-- Protocolos -->
            <a href="router.php?page=mis_denuncias" class="menu-item">
