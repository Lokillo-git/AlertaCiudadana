...
$denuncias = $adminController->ListarTotalDenuncias(); // Obtenemos las denuncias resueltas
?>
...
<div class="main-content">
    <div class="worker-content">
        <div class="content-header">
            <h1 class="page-title">Todas las Denuncias</h1>
        ...
        <div class="denuncias-grid">
            <?php if (empty($denuncias)): ?>
                <div class="alert alert-info" style="grid-column: 1 / -1;">
                    No hay denuncias que mostrar
                </div>
            <?php else: ?>
                <?php foreach ($denuncias as $denuncia): ?>
                    <div class="denuncia-card" data-estado="<?php echo htmlspecialchars($denuncia['estado']); ?>">
                        ...
                        <div class="denuncia-body">
                            ...
                            <div class="denuncia-meta">
                                ...
                                <?php if (!empty($denuncia['nombre_agente'])): ?>
                                    <span><i class="fas fa-user"></i> <?php echo htmlspecialchars($denuncia['nombre_agente'] . ' ' . $denuncia['apellido_agente']); ?></span>
                                <?php endif; ?>
                            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#filtro-estado').change(function() {
            ...
            $('.denuncia-card').each(function() {
                const cardEstado = $(this).data('estado');

                if (estadoSeleccionado === 'todos' || cardEstado === estadoSeleccionado) {
                    $(this).show();
                } else {
                    $(this).hide();
                }
