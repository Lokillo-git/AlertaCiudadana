...
$denuncias = $adminController->ListarDenunciasReueltas(); // Obtenemos las denuncias resueltas
?>
...
<div class="main-content">
    <div class="worker-content">
        <div class="content-header">
            <h1 class="page-title">Denuncias Resueltas</h1> <!-- Cambiado el título para reflejar el contenido -->
        </div>

        <div class="denuncias-grid">
            <?php if (empty($denuncias)): ?>
                <div class="alert alert-info" style="grid-column: 1 / -1;">
                    No hay denuncias resueltas para mostrar.
                </div>
            <?php else: ?>
                <?php foreach ($denuncias as $denuncia): ?>
                    <!-- Eliminé la condición if($denuncia['estado'] === 'resuelto') ya que ahora solo obtenemos resueltas -->
                    <div class="denuncia-card">
                        <div class="denuncia-header">
                            <h3 class="denuncia-title"><?php echo htmlspecialchars($denuncia['titulo']); ?></h3>
                            <span class="denuncia-status status-resuelto">
                                Resuelto
                            </span>
                        </div>
