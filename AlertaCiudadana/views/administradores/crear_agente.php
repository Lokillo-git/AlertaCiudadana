...
<div class="main-content">
    <div class="admin-content">
        <div class="content-header">
            <h1 class="page-title">
                <?php echo $modo === 'editar' ? 'Editar Agente Gubernamental' : 'Registrar Nuevo Agente Gubernamental'; ?>
            </h1>
            <a href="router_admin.php?page=listar_agentes" class="btn btn-secondary">
                <i class="fas fa-arrow-left"></i> Volver
            </a>
        </div>

        <div class="form-container">
            <form id="agenteForm" action="router_admin.php?page=<?php echo ($modo === 'editar') ? 'actualizar_agente&id=' . $agente['id'] : 'guardar_agente'; ?>" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="modo" value="<?php echo $modo; ?>">

                <div class="form-group">
                    <label for="nombre" class="form-label">Nombre Completo</label>
                    <input type="text" id="nombre" name="nombre" class="form-control" value="<?php echo $modo === 'editar' ? htmlspecialchars($agente['nombre']) : ''; ?>" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div style="display: flex;">
                        <input type="text" id="email" name="email" class="form-control"
                            value="<?php echo $modo === 'editar' ? explode('@', $agente['email'])[0] : ''; ?>"
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="telefono" name="telefono" class="form-control" value="<?php echo $modo === 'editar' ? htmlspecialchars($agente['telefono']) : ''; ?>" required>
                </div>

                <div class="form-group">
                    <label for="categoria_id" class="form-label">Categoría</label>
                    <select id="categoria_id" name="categoria_id" class="select-categoria" required>
                        <option value="">Seleccione una categoría</option>
                        <option value="0" <?php echo ($modo === 'editar' && empty($agente['categoria_id'])) ? 'selected' : ''; ?>>
                            Sin categoría
                        </option>
                        <?php foreach ($categorias as $categoria): ?>
                            <option value="<?php echo $categoria['id']; ?>" <?php echo ($modo === 'editar' && $agente['categoria_id'] == $categoria['id']) ? 'selected' : ''; ?>>
                ...
                <div class="form-group">
                    ...
                    <img id="photoPreview"
                        class="photo-preview"
                        src="<?php echo ($modo === 'editar' && !empty($agente['foto_perfil'])) ? 'data:image/jpeg;base64,' . base64_encode($agente['foto_perfil']) : ''; ?>"
                        style="display: <?php echo ($modo === 'editar' && !empty($agente['foto_perfil'])) ? 'block' : 'none'; ?>;">
                </div>
                ...
                <div style="text-align: right; margin-top: 2rem;">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> <?php echo $modo === 'editar' ? 'Actualizar Agente' : 'Guardar Agente'; ?>
                    </button>
                </div>
            </form>
