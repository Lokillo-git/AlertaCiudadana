...
$denuncias = $protocoloController->obtenerDenunciasAsignadas();
                    ...
                    <?php if ($denuncia['estado'] === 'en_proceso'): ?>
                        <div class="denuncia-card">
                            ...
                            <div class="denuncia-footer">
                                ...
                                <a href="router.php?page=seguimiento_protocolo&id=<?= $denuncia['id'] ?>" class="btn btn-success">
                                    <i class="fas fa-eye"></i> Continuar Protocolo
                                </a>
                            </div>
                        </div>
                    <?php endif; ?>
